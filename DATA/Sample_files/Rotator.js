define([
	...
	var Rotator = declare("custom.Rotator", null, {
		// summary:
		...
		//	|		require("dojo/parser", "dojo/domReady!", "custom/Rotator", "custom/Rotator/Fade"],
		//	|           function(parser) { parser.parse(); });
		//	|	</script>
		//	|	<div dojoType="custom/Rotator" transition="custom/Rotator/crossFade">
		//	|		<div>Pane 1!</div>
		//	|		<div>Pane 2!</div>
		//	|	</div>
		...
		constructor: function(/*Object*/params, /*DomNode|string*/node){
			...
			//console.log(node);
			//query("div.spws_maskhead_rotator_pane", node).forEach(function(n, i){
		...
		go: function(/*int|string?*/p){
			...
			dojo.query(".rotatorbullet").forEach(function(node, index, arr){
				if (index==p) {
